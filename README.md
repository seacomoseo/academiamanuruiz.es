...
- If new project (not fork):
  - Copy [academiamanuruiz.es project files](https://github.com/academiamanuruiz/academiamanuruiz.es)
...
- `README.md` ⏩ edit baseURL ("academiamanuruiz.es") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/academiamanuruiz/settings/domain)
  - `Add custom domain`
  - `Check DNS configuration` Copy
  - Add `DNS Records` copied from Netlify to Domain gestor:
    - From: `academiamanuruiz.es`
    ...
    - From: `www`
      DNS Record: `CNAME`
      To: `academiamanuruiz.netlify.app.`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/academiamanuruiz/domains)
  - `Set up a custom domains`
  - `academiamanuruiz.es`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.academiamanuruiz.es`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/academiamanuruiz/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de academiamanuruiz.es`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/academiamanuruiz/forms)
...
1. [Servicios academiamanuruiz.es](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
